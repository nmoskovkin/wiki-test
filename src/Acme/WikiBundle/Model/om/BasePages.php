...
abstract class BasePages extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'Acme\\WikiBundle\\Model\\PagesPeer';
    ...
    public function setHeader($v)
    {
        ...
        if ($this->header !== $v) {
            $this->header = $v;
            $this->modifiedColumns[] = PagesPeer::HEADER;
        }
    ...
    public function setBody($v)
    {
        ...
        if ($this->body !== $v) {
            $this->body = $v;
            $this->modifiedColumns[] = PagesPeer::BODY;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->header = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            ...
            return $startcol + 4; // 4 = PagesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PagesPeer::HEADER)) {
            $modifiedColumns[':p' . $index++]  = '`header`';
        }
        if ($this->isColumnModified(PagesPeer::BODY)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PagesPeer::HEADER)) $criteria->add(PagesPeer::HEADER, $this->header);
        if ($this->isColumnModified(PagesPeer::BODY)) $criteria->add(PagesPeer::BODY, $this->body);
