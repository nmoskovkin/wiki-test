...
use Acme\WikiBundle\Model\map\PagesTableMap;
...
abstract class BasePagesPeer
{
    ...
    const OM_CLASS = 'Acme\\WikiBundle\\Model\\Pages';
    ...
    const PARENT = 'pages.parent';

    /** The default string format for model objects of the related table **/
    const DEFAULT_STRING_FORMAT = 'YAML';

    /**
     * An identiy map to hold any loaded instances of Pages objects.
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Header', 'Body', 'Parent', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'header', 'body', 'parent', ),
        BasePeer::TYPE_COLNAME => array (PagesPeer::ID, PagesPeer::HEADER, PagesPeer::BODY, PagesPeer::PARENT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'HEADER', 'BODY', 'PARENT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'header', 'body', 'parent', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Header' => 1, 'Body' => 2, 'Parent' => 3, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'header' => 1, 'body' => 2, 'parent' => 3, ),
        BasePeer::TYPE_COLNAME => array (PagesPeer::ID => 0, PagesPeer::HEADER => 1, PagesPeer::BODY => 2, PagesPeer::PARENT => 3, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'HEADER' => 1, 'BODY' => 2, 'PARENT' => 3, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'header' => 1, 'body' => 2, 'parent' => 3, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(PagesPeer::HEADER);
            $criteria->addSelectColumn(PagesPeer::BODY);
            $criteria->addSelectColumn(PagesPeer::PARENT);
        } else {
